###########################################################################
## Makefile generated for component 'Ranging_Estimator0'. 
## 
## Makefile     : Ranging_Estimator0.mk
## Generated on : Mon May 31 18:22:41 2021
## Final product: ./Ranging_Estimator0_rtwlib.a
...
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = Ranging_Estimator0_rtwlib.a
...
PRODUCT = ./Ranging_Estimator0_rtwlib.a
...
DEFINES_STANDARD = -DMODEL=Ranging_Estimator0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/Ranging_Estimator0/Ranging_Estimator0.c
...
%.o : $(START_DIR)/slprj/ert/Ranging_Estimator0/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/slprj/ert/Ranging_Estimator0/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/Ranging_Estimator0/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Ranging_Estimator0.o : $(START_DIR)/slprj/ert/Ranging_Estimator0/Ranging_Estimator0.c
	$(CC) $(CFLAGS) -o "$@" "$<"
