###########################################################################
## Makefile generated for component 'Ultrasonic_Ranging_Sensor0'. 
## 
## Makefile     : Ultrasonic_Ranging_Sensor0.mk
## Generated on : Thu Jun 03 18:45:02 2021
## Final product: ./Ultrasonic_Ranging_Sensor0_rtwlib.a
...
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
MODELLIB                  = Ultrasonic_Ranging_Sensor0_rtwlib.a
...
SLIB_PATH        = C:/Users/GUOHUI~1/DOCUME~1/MATLAB/R2020b/ARDUIN~1/ARDUIN~1/FASTER~1
...
PRODUCT = ./Ultrasonic_Ranging_Sensor0_rtwlib.a
...
DEFINES_ = -D__MW_TARGET_USE_HARDWARE_RESOURCES_H__ -DMW_TIMERID=1 -DMW_PRESCALAR=8 -DMW_TIMERCOUNT=65534 -DMW_SCHEDULERCOUNTER=1 -D_RTT_BAUDRATE_SERIAL0_=9600 -D_RTT_ANALOG_REF_=0
...
DEFINES_STANDARD = -DMODEL=Ultrasonic_Ranging_Sensor0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
SRCS = $(START_DIR)/slprj/ert/Ultrasonic_Ranging_Sensor0/Ultrasonic_Ranging_Sensor0.c
...
OBJS = Ultrasonic_Ranging_Sensor0.o
...
%.o : $(START_DIR)/slprj/ert/Ultrasonic_Ranging_Sensor0/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/slprj/ert/Ultrasonic_Ranging_Sensor0/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/slprj/ert/Ultrasonic_Ranging_Sensor0/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
Ultrasonic_Ranging_Sensor0.o : $(START_DIR)/slprj/ert/Ultrasonic_Ranging_Sensor0/Ultrasonic_Ranging_Sensor0.c
	$(CC) $(CFLAGS) -o "$@" "$<"
